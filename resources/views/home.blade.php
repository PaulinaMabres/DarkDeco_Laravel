    ...
    <div class="container">
      <div class="row pt-5">
        ...
        <div class=" mx-auto justify-content-center d-none d-sm-block">
          ...
          <p class="col-12 text-muted text-center mx-auto h3 font-weight-light" style="max-width: 40vw;"> Camas, sillas, mesas, percheros, armarios, sofás, todo eso y más en un estilo contemporáneo</p>
        </div>
      </div>
    </div>
  </section>
          ...
          <div class="d-flex flex-column ">
            <div class="col-md-12 text-center mb-5">
              ...
              <p class="text-muted h4 ">
                Visitá nuestra sección de navidad que diseñamos especialmente para vos
              </p>
            </div>
        ...
        <div class="col-md-4 d-flex align-items-center">
          <div class="d-flex flex-column ">
            ...
            <div class="col-md-12 text-center">
              ...
              <p class="text-muted h4">
                O realizá un regalo sorpresa a un ser querido
              </p>
            </div>
          </div>
        </div>
